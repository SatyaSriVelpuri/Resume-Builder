export const landingPageStyles = {
  ...
  // heroGrid:
  //   "grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-[1fr_auto] gap-6 items-center",
  // heroGrid: "grid grid-cols-1 md:grid-cols-2 items-center gap-12",
  heroGrid:
    "flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-12",
...
export const infoStyles = {
  ...
  progressBar: (color) => `h-full rounded-full transition-all ${color}`,
  ...
  certYear: (bgColor) =>
    `text-xs font-bold text-white px-3 py-1 rounded-lg ${bgColor}`,
  ...
  workDuration: (color) => `text-sm font-bold italic ${color}`,
