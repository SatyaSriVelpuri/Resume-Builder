...
const ThemeSelector = ({selectedTheme,setSelectedTheme,resumeData,onClose}) => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4">
      {/* header */}
      <div className="flex flex-col sm:flex-row items-start sm-items-center jusitify-between gap-4 mb-8 p-4 sm:p-6 bg-gradient-to-r from-white to-violet-50 rounded-2xl border border-violet-100">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-5 gap-6 lg:gap-8">
        ...
        {/* RIGHT AREA */}
        <div
          className="lg:col-span-3 bg-whiterounded-2xl border border-gray-100 p-4 sm:p-6"
          ref={resumeRef}
        >
          <RenderResume
