...
//take you back to previous form state orit will take you to dashboard if you are on the first page 
  const goBack = () => {
    const pages = [
      "profile-info",
      "contact-info",
...
//fetching resume detains using backened URL 
   ...
   //it will helpin choosing preview and in downlaoding the resume also saves the resume and image 
   const uploadResumeImages = async () => {
     try {
       ...
       //store the image as resume as.png
   ...
   //this  function will helphelp in updating  the resume and will help in updation on backend
  ...
  //this function helps in dowloading pdf 
  ...
  //helps choose from multiple themes
  ...
  return (
    <DashboardLayout>
        ...
        <div className={containerStyles.grid}>
          <div className={containerStyles.formContainer}>
            ...
            <div className="p-4 sm:p-6">
              ...
              <div className="flex flex-wrap items-center justify-and gap-3">
                <button
      ...
      {/* Thumbnail error fix */}
      <div styles={{display: "none"}} ref={thumbnailRef}>
