...
// import cardStyles from "./Cards.module.css"; if css module is needed instead of dummyStyles use the commeneted statemnt 
//PROFILE INFO
...
export const ResumeSummaryCard = ({
  ...
  return (
    <div
      ...
      onClick={onSelect}
      onMouseEnter={() => setIsHovered(true)} //mouse or swipe forr mobile view 
...
export const TemplateCard =({thumbnailImg,isSelected,onSelect})=>{
  return(
    <div className={`group h-auto md-h-[300px] lg:[320px] flex flex-col bg-white border-2 overflow-hidden cursor-pointer transition-all duration-500 hover:scale-105 hover:shadow-lg rounded-3xl 
      ${
      ...
      {thumbnailImg ?(
        <div className="relative w-full h-full overflow-hidden">
          ...
          <div className ="absolute insert-0 bg-gradient-to-t from-white/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300"/>
          {isSelected && (
            <div className="absolute insert-0 bg-violet-500/10 flex items-center justify-center">
          ...
          {/* hover effect */}
          <div className ="absolute insert-0 bg-gradient-to-t from-violet-100/30 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300">
          </div>
        </div>
      ):(
